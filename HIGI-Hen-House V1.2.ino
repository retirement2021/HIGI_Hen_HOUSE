//System uses an ESP32S3 board. Arduino IDE: ESP32S3 Dev Module
//======================================================
// LIBRARYS
//======================================================
...
#define NIGHT_LED1_PIN 13  // RED LED to GND. Installed above the Coop door for visual referance. 100R resistor.
#define NIGHT_LED2_PIN 14  // RED LED to GND. Installed above the Coop door for visual referance.  100R resistor.
...
void handleEventScroll() {
  ...
  if (!buttonDown && buttonWasDown) {
    ...
    if (pressTime < 500) {
      ...
      // -------------------------------------------------
      currentPage =
        (DisplayPage)((currentPage + 1) % 5);  // to add a display page change % 5 to % 6
