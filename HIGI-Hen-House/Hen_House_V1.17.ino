...
const char systemVersion[] = "V1.17";
...
// Soltice twilight end +45 minutes. Default +27
// **** Example: Door closing at +20, plus 2 minutes +27.(light turns off 2 minutes after door closes)
int lightOffMinutesBST = +27;
